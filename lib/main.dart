...
import 'package:gravitydemo/core/routes/router_provider.dart';
...
void main() {
  ...
  Get.lazyPut<CardRepository>(() => CardRepositoryImpl(Get.find()));
  Get.lazyPut<GetAllCardUsecase>(() => GetAllCardUsecase(Get.find()));
  Get.lazyPut<GetCardBySetNameUsecase>(
      () => GetCardBySetNameUsecase(Get.find()));
  runApp(const MyApp());
}
